...
export class PaymentController {
  ...
  @Post('stripe/create')
  async createStripePayment(@Body() body: { amount: number; currency: string; userId: string; tenantId: string }) {
    return this.paymentService.createStripePayment(body.amount, body.currency, body.userId, body.tenantId);
  }
